     ...
     <div
              ...
              >
                ...
                <div className="absolute top-3 right-3 sm:top-4 sm:right-4">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-white/20 backdrop-blur-sm rounded-full flex datas-center justify-center opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-500 delay-100 hover:bg-white/30 cursor-pointer">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 text-white">
                  ...
                  <div className="opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-500 mb-4">
                    ...
                    <div className="flex datas-center justify-between">
                      ...
                      <div className="flex datas-center text-yellow-400">
