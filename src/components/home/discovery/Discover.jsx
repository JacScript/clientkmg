        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <Reveal delay={0.5}>
            <h2 className="text-3xl sm:text-4xl md:text-5xl xl:text-5xl font-black font-roboto leading-tight mb-6">
              {res?.heading || "Explore Paris, and the neighbouring EU cities with Kai and KM travel and tours"}
            </h2>
          </Reveal>

          <Reveal delay={1.3}>
            <p className="text-sm sm:text-base md:text-lg font-serif leading-relaxed mb-6 max-w-prose mx-auto lg:mx-0">
              {res?.subheading || "Kai specialises in guiding Tanzanians through unforgettable journeys across France and neighboring EU cities, offering full support from visa application to local experiences that feel like home never missing a spot."}
            </p>
          </Reveal>

          <div className="flex justify-center lg:justify-start">
            <Link 
            href={res?.buttonLink || '#homecontact'}
  isWhatsApp={false} 
  className="bg-[#000080] hover:bg-[#000080] text-white px-6 py-3 rounded-md shadow-lg"
>
  {res?.buttonText || "Contact Us"}
</Link>
        ...
        <div className="w-full lg:w-1/2">
          <FadeInImage
            src={res.image || "https://res.cloudinary.com/dwkivuqts/image/upload/v1750388539/img19_peizvu.jpg"}
            alt="City Discovery"
