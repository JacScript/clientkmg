...
const TopBar = () => {
  // Define your locations with Google Maps links
  const locations = [
    {
      address: "14 Nakwambela Street, Bahari Beach, Dar Es Salaam, Tanzania",
      mapsUrl: "https://www.google.com/maps/search/?api=1&query=14+Nakwambela+Street,+Bahari+Beach,+Dar+Es+Salaam,+Tanzania"
    },
    {
      address: "74 Rue Du Marechal Foch, 76350 Oissel, France",
      mapsUrl: "https://www.google.com/maps/search/?api=1&query=74+Rue+Du+Marechal+Foch,+76350+Oissel,+France"
    }
  ];
      ...
      <div className="w-full h-1/3 bg-blue-400 ">
        ...
        <div className="lg:w-full xl:w-3/4 mx-auto opacity-100 h-full px-6 flex items-center justify-end md:justify-between">
          ...
          <div className="hidden md:flex text-white items-center">
            <div className="mr-2 items-center hidden lg:flex">
              <MdLocationOn className="mr-2" size={18} />
              {/* Dynamic Location with flip transition and Google Maps link */}
              <a
                href={locations[currentLocationIndex].mapsUrl}
                target="_blank"
                rel="noopener noreferrer"
                className={`cursor-pointer hover:text-blue-200 transition-all duration-300 ease-in-out transform-gpu ${
                  isFlipping ? 'rotate-y-180' : 'rotate-y-0'
                }`}
                style={{
                  transformStyle: 'preserve-3d',
          ...
          <div className="flex text-white items-center justify-center gap-4 z-40 ">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="text-medium lg:text-base cursor-pointer transition-colors duration-300 ease-in-out hover:text-blue-200"
              >
                Book Now
              </a>
            ...
            <div className="flex space-x-4 text-white ">
              <IconComponent link="https://wa.me/33771948786?text=Hello" icon={FaWhatsapp}/>
              <IconComponent link="#" icon={FaXTwitter}/>
              <IconComponent className='cursor-pointer' link="https://instagram.com/kmgroup.travel_and_tours/" icon={FaInstagram}/>
            </div>
          </div>
        </div>
      </div>
