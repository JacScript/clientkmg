...
const NespressoSustainability = ({
  heading = "Good coffee should be good for the planet too.",
  subheading = "From farm to cup, we're working toward capsules made entirely from recycled aluminum and a coffee supply chain that gives back to the communities that grow it.",
  stats = DEFAULT_STATS,
}) => {
  return (
