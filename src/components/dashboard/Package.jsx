...
//   FaChartLine, FaLayerGroup, FaGem, FaRocket, FaMagic, FaUpload, FaCloudUploadAlt
// } from 'react-icons/fa';
// import { createPackage, deletePackage, getPackages, updatePackage } from '../../http/index';
// import PackageForm from './FormPackage';
// import PackageViewModalContent from './PackageViewModalContent';
...
//       enqueueSnackbar('⚠️ Please select an image file.', { variant: 'warning' });
//       return;
//     }
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden flex flex-col">
...
//       <div 
//         ref={mainContentRef}
//         className="flex-1 relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 overflow-y-auto"
//         style={{ 
//           scrollbarWidth: 'none', 
...
//             #${mainContentRef.current.id}::-webkit-scrollbar {
//               display: none;
//             }
//           ` : ''}
//         `}</style>
