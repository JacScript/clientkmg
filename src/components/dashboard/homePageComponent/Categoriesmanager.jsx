    ...
    <div className="bg-white shadow rounded-lg p-6 space-y-5">
      ...
      <div className="space-y-3">
        {categories.map((cat) => {
          ...
          return (
            <div key={cat._id} className="grid grid-cols-1 sm:grid-cols-[1fr_2fr_1fr_70px_auto] gap-2 items-center bg-gray-50 p-3 rounded-lg border border-gray-200">
              <input
                type="text"
                value={row.slug}
                disabled={!isEditing}
                ...
                placeholder="slug"
                className="w-full px-2 py-1.5 border border-gray-300 rounded-lg text-sm font-mono disabled:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-blue-500"
              />
              <input
                type="text"
                value={row.label}
                ...
                placeholder="Label"
                className="w-full px-2 py-1.5 border border-gray-300 rounded-lg text-sm disabled:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-blue-500"
              />
              <input
                type="text"
                value={row.icon || ''}
      ...
      <div className="pt-3 border-t border-gray-200">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-[1fr_2fr_1fr_70px_auto] gap-2 items-center">
          <input
            type="text"
            value={newCategory.slug}
            onChange={(e) => setNewCategory((p) => ({ ...p, slug: e.target.value }))}
            placeholder="slug"
            className="w-full px-2 py-1.5 border border-gray-300 rounded-lg text-sm font-mono focus:outline-none focus:ring-1 focus:ring-blue-500"
          />
          <input
            type="text"
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 bg-green-600 hover:bg-green-700 text-white px-3 py-1.5 rounded-lg text-sm font-semibold whitespace-nowrap"
          >
