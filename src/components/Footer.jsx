...
const Footer = () => {
  return (
    <footer className='w-full bg-[#068DDE] text-white py-4 flex justify-between items-center px-6'>
        ...
        <p className='border-r-2 border-r-[#000080] flex items-center pr-4'> <span className='text-xl mr-2'> 	&copy; </span>2025 GM Group. All rights reserved.</p>
           
           <p className='ml-4 flex items-center'>Privacy Policy | Terms of Service</p>
        </div>
